...
function cff_add_admin_menu() {
    ...
    add_options_page(
        'CopticCal Help',           // Page title
        'CopticCal Help',           // Menu title
        'manage_options',           // Capability required to see it
        'copticcal-help',           // Menu slug
        'cff_render_help_page'      // Callback function to render the page
    );
}
...
function cff_render_help_page() {
    ...
    <div class="wrap">
        ...
        <p>Welcome to the CopticCal plugin! Use the shortcodes below to display Coptic fasts and feasts anywhere on your site.</p>
        ...
        <table class="form-table" role="presentation">
            <tbody>
                <tr>
                    <th scope="row"><h2><code>[cff_table]</code></h2></th>
                    <td>
                        <p>Displays a complete table of Coptic fasts and feasts.</p>
                        <p><strong>Optional Attributes:</strong></p>
                        <p><code>year</code> — Specify a Gregorian year. For example, typing <code>[cff_table year="2025"]</code> will display the calendar for 2025. If you do not include a year, it will automatically default to the current year.</p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><h2><code>[cff_today]</code></h2></th>
                    <td>
                        <p>Displays the specific fast or feast happening today. If there is no event today, it remains blank.</p>
                        <p><em>Note: This shortcode does not require any attributes. Just paste it exactly as is.</em></p>
                    </td>
                </tr>
            </tbody>
        </table>
