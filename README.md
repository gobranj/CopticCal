...
2. Upload the file to your WordPress /wp-content/plugins/coptic-cal/ directory.
...
1. Update the version number in the plugin header and the $current_version variable in the code.
2. Create a new Release on GitHub with a tag (e.g., v1.1) that matches your new version number.
Author
• Joseph Gobran
Version 1.0
